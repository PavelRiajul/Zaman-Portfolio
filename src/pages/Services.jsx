    ...
    <section className="container mx-auto max-w-screen-2xl py-6 px-4">
        <div>
           ...
           <div className="flex justify-between">
            ...
            <button className="flex items-center justify-center gap-2 px-6 py-2 rounded-full bg-[#F9AD1B]">See More<FaArrowRight  className=" rounded-full  bg-white "/></button>
            </div>
            {/* card design */}
            <div className="mt-10">
                <div className=" flex justify-around  gap-6    ">
                <motion.div drag className="card w-[345px]  flex flex-col rounded-2xl shadow-2xl  hover:scale-75 transition-all gap-3 p-8 ">
