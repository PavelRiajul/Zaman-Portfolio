        ...
        {/* text content */}
            <div className="w-[50%]">
                ...
                <div className="btn-group space-x-3">
                    ...
                    <button className=" text-black btn cursor-pointer hover:bg-[#F9AD1B] hover:text-white transition-all border-2 border-gray-500 font-semibold px-8 py-2 rounded-full animate__animated animate__backInRight">Whatsapp</button>
                </div>
            </div>
       
        {/* right image */}
        <div className=" -mt-16 img-1-group" >
            <motion.img src={zaman} alt=""  className="w-[680px] img-1" drag
