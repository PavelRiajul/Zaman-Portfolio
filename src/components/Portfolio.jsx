...
//         </div>
//         {/* project cards */}
//         <div className="cards-item mt-5 flex flex-col sm:flex-col md:flex-row justify-between items-center gap-5">
//          <div className="cards  w-[25%] hover:scale-125 transition-all flex flex-col items-center rounded-md shadow-2xl p-2   ">
...
//          </div>
//          <div className="cards  w-[25%] flex flex-col hover:scale-125 transition-all items-center rounded-md shadow-2xl p-2  ">
...
const Portfolio = () => {
  return (
    <section className="container mx-auto max-w-screen-2xl py-20 px-4">
        ...
        {/* project cards */}
        <div className="cards-item mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
         <div className="cards w-full sm:w-[48%] md:w-[100%] hover:scale-105 transition-all flex flex-col items-center rounded-md shadow-2xl p-2">
            <img src={card1} alt="card1" className="rounded-md w-full" />
            <h2 className="p-2 mt-2 leading-7 hover:text-gray-950 transition-all pt-2 font-medium text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio tempore unde.</h2>
         </div>
         <div className="cards w-full sm:w-[48%] md:w-[100%] hover:scale-105 transition-all flex flex-col items-center rounded-md shadow-2xl p-2">
            <img src={card2} alt="card2" className="rounded-md w-full" />
            <h2 className="p-2 mt-2 leading-7 hover:text-gray-950 transition-all font-medium text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio tempore unde.</h2>
         </div>
         <div className="cards w-full sm:w-[48%] md:w-[100%] hover:scale-105 transition-all flex flex-col items-center rounded-md shadow-2xl p-2">
            <img src={card3} alt="card3" className="rounded-md w-full" />
            <h2 className="p-2 mt-2 leading-7 hover:text-gray-950 transition-all pt-2 font-medium text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio tempore unde.</h2>
         </div>
         <div className="cards w-full sm:w-[48%] md:w-[100%] hover:scale-105 transition-all flex flex-col items-center rounded-md shadow-2xl p-2">
            <img src={card4} alt="card4" className="rounded-md w-full" />
            <h2 className="p-2 mt-2 leading-7 hover:text-gray-950 transition-all pt-2 font-medium text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio tempore unde.</h2>
         </div>
        </div>
        </div>           
